...
const collectionId = "pbcnilaitbq0011";
const collectionName = "nilai_tathbiq";
...
runSql(`create unique index if not exists idx_nilaitbq_siswa_materi on ${collectionName}(siswa, materi);`);
...
const values = [
  ...
  sqlString(JSON.stringify(["create unique index idx_nilaitbq_siswa_materi on nilai_tathbiq (siswa, materi)"])),
...
console.log("Collection nilai_tathbiq siap digunakan.");
